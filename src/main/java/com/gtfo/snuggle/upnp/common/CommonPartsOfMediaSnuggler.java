package com.gtfo.snuggle.upnp.common;

import com.gtfo.snuggle.common.CommonConstantsOfMediaSnuggler;
import com.gtfo.snuggle.upnp.content.music.MediaStoreAudio;
import com.gtfo.snuggle.upnp.content.photos.MediaStorePhoto;
import org.fourthline.cling.model.meta.ManufacturerDetails;
import org.fourthline.cling.model.meta.ModelDetails;

import java.text.SimpleDateFormat;

public class CommonPartsOfMediaSnuggler {
    public static final String MEDIA_SNUGGLER_ICON =
    ...
    public static final int WIDTH = 48, HEIGHT = 48, DEPTH = 24, ZERO = 0;

    public static final String IMAGE_PNG = "image/png";

    public static final ManufacturerDetails MANUFACTOR = new ManufacturerDetails(
            "VegardAasen", "http://www.vegaasen.com/");

    public static final ModelDetails MODEL_DETAILS = new ModelDetails(
            CommonConstantsOfMediaSnuggler.APPLICATION_NAME, "Media share for the people!", "0.1a", "http://www.vegaasen.com/apps");

    public static final SimpleDateFormat DEFAULT_MEDIA_DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd");

    public static final String DEFAULT_ARTIST_ROLE_IF_UNKNOWN = "Unknown", DEFAULT_ARTIST_NAME_IF_UNKNOWN = "Unknown";

    public static final String MEDIA_AUDIO_DEFAULT_MIME_TYPE_IF_NOT_FOUND = "audio/*";
    public static final String MEDIA_VIDEO_DEFAULT_MIME_TYPE_IF_NOT_FOUND = "video/*";

    public static boolean elementExistsWithinContainer(Object item) {
        return (item != null);
    }
