...
public class MediaDBContent extends DIDLContent implements Content {
    ...
    private final MediaStoreObservers mediaStoreObservers;
    ...
    public MediaDBContent(Context context, URLBuilder urlBuilder) {
        ...
        this.mediaStoreObservers = new MediaStoreObservers(context, rootContainer);
    }

    public void registerObservers() {
        mediaStoreObservers.register();
    }

    public void unRegisterObservers() {
        mediaStoreObservers.unRegister();
    }

    public void updateAll() {
        mediaStoreObservers.updateAll();
    }
